...
class Soybean extends Protein{
    @Override
    public String getNutritionInfo() {return "gained 446 kcal, 36.5g protein, 30.2g carbs, 19.9g fat from Soybean.";}
}
...
class MeatCattleFoodFactory extends AbstractFoodFactory{
    @Override
    public Carbohydrate createCarbohydrateFood() {return new Wheat();}
    @Override
    public Protein createProteinFood() {
        return new Canola();
    }
